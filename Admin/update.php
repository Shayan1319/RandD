...
location.replace('logout.php')
    ...
    $query= mysqli_query($conn,"UPDATE `login` SET `Name`='$Name',`Father_Name`='$Father_Name',`University`='$University',`Registration_Numberv`='$Registration_Number',`Address`='$Address',`Phone_Number`='$Phone_Number',`Email`='$Email',`Password`='$Password',`Image`='$filename', `Department`='$Department' WHERE `Id`='$updateid'");
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <h1 class="white ts-title bold shadow">Designation <?php  echo $fach['Designation'];?></h1>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-12">
                <div class="about p-5 rounded-5">
                    ...
                    <h3>Registration_Number   :   <input type="text" name="Registration_Number" id="Registration_Number" class="form-control" value="<?php  echo $fach['Registration_Numberv'];?>"></h3>
                    <h3>Image   :    <input onchange="loadFile(event)" type="file" name="file" id="file" >
