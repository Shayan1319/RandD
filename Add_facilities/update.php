...
location.replace('logout.php')
    ...
    $query= mysqli_query($conn,"UPDATE `login` SET `Name`='$Name',`Father_Name`='$Father_Name',`University`='$University',`Registration_Numberv`='$Registration_Number',`Address`='$Address',`Phone_Number`='$Phone_Number',`Email`='$Email',`Password`='$Password',`Image`='$filename' WHERE `Id`='$updateid'");
       if($query){
        echo "updated";
       }else{
        echo "wrong";
